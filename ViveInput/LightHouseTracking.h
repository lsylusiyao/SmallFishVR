...
private:
	...
	vr::HmdVector3_t QuaternionToEulerAngleRevised(vr::HmdQuaternion_t matrix);

	// data needed by GUI
	vr::HmdVector3_t posVector[3]; //HMD, left, right
	vr::HmdVector3_t eularAngle[3]; //HMD, left, right
